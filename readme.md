...
Cara direkomendasikan untuk menjalankan project ini adalah menggunakan **Docker** sehingga Anda tidak perlu menginstal dependensi (ffmpeg, nodejs) secara manual.

### Prasyarat

Pastikan sistem Anda sudah memiliki kelengkapan berikut:
1. Git
2. Docker
3. Docker Compose
...
```bash
git clone https://github.com/ricoagista/Venyx.git
cd Venyx
```
