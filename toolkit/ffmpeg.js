...
/** !-======[ Experimentall ▪︎ Bell🦋 ]======-!
      https://github.com/ricoagista/Venyx
      
      * Coding by @ricoagista *     
      
      🩵 Follow ️me on :
      ▪︎ https://youtube.com/@ricoagista  
      ▪︎ https://github.com/ricoagista
      ▪︎ https://instagram.com/RICO.p.p?igshid=ZGUzMzM3NWJiOQ==
      ▪︎ https://www.threads.net/@ricoagista
      ▪︎ https://termai.cc
*/
...
export async function generateWaveform(
  inputBuffer,
  bars = 64,
  url = 'https://github.com/ricoagista, https://termai.cc'
) {
  return new Promise((resolve, reject) => {
    const inputStream = new PassThrough();
